	...
	<main class="content" id="page-1">

		<div class="wrapper">

			<div class="main">

				<h2 class="main-title"><span class="text-success">RESULTS:</span> Your Personalized Plan To Stop Hair Loss.</h2>
				...
				<p class="main-text">Based off the answers, our analysis shows that Shapiro MD’s hair care aid system is the recommended option. Please view a brief summary of your selections and analysis below. In addition we’ve selected the solution best suited for you; we are even offering up to 30&permil; OFF on the 4 Month Supply offer below, saving you over $100 (Offer only valid to first time customers)</p>
				...
				<div class="percrain">
					...
					<div class="box-score">
						...
						<div class="ko-progress-circle" data-progress="0">
							...
							<div class="ko-progress-circle__overlay"><strong>A+</strong>Hair-loss <br> repair score</div>
				...
				<div class="box-report">
					...
					<h5 class="box-report__title"><i class="ic ic--file-ok"></i> Our customized hair loss analysis has determined the following as problematic hair loss areas that should be addressed. Expect first results, based on your <div class="value1" style="display:inline;"><?php echo $_SESSION['value'][1]; ?></div>, between 6 and 8 weeks. You may experience results sooner if you use Shapiro MD more than 4 times / week.  You have only been experiencing hair loss for <div class="value5" style="display:inline;"><?php echo $_SESSION['value'][5]; ?></div>, so the good news is there is not that much DHT built up on your hair follicles. If you commit to stopping your hair loss now, you will should be able to based on the information you have provided.
					...
					<div class="box-report-left">
						...
						<p style="font-size: 15px; color: #726272;"><strong>Recommended routine:</strong>.  Use Shapiro MD Shampoo and Conditioner at least 4 times / week to stop your hair loss and help restore your hair back to where you want it! For fastest results, we recommend leaving the shampoo in for 5 minutes (20 minutes max) after applying it, typically before you get in the shower.</p>
...
or breast feeding, because of potential hormonal risk on an unborn or nursing child. Please check with your physician if you have sensitivity to any ingredient of this shampoo.
				...
				<div class="results">
					...
					<div class="results__content">
						...
						<h4>THE LEADING HAIR LOSS SOLUTION</h4>

						<h2>#1 Leading Solution Patented For Hair Loss</h2>
						...
						<ul class="bp-list">
							...
							<li>Archive Thicker & Fuller Hair</li>
					...
					<div class="results__img">
						...
						<img src="img/shampoo2.png?ver1.0" alt="">

					</div>

				</div>

				<div class="get-started" style="margin-top: 20px;padding-right: 17px;">
				...
				<div class="but">
					...
					<p>But <strong>you won’t find this complete hair loss solution in retail stores</strong>, so, don’t miss this one-time opportunity to order direct from the doctors and lab that has made it possible, by selecting a package now.</p>
				...
				<div class="accordion">
					...
					<div class="accordion__item">
						...
						<div class="accordion__body">
							...
							<p>For best results we recommend users purchase a 4 month supply of the system. Shapiro MD Shampoo and Conditioner should be used with every shower. Applying to a moist scalp for up to 20 minutes can maximize the benefit. However, many patients have experienced benefits by applying at the beginning of their shower and rinsing at the end of their shower. </p>
				...
				<h3 class="content-title-small">HOW SHAPIRO MD WORKS TO STOP HAIR LOSS & STIMULATE HAIR </h3>
				...
				<h2 class="content-title"><span>The Science Behind </span></h2>
 				...
 				<div class="behind-step">
 					...
 					<div class="behind-step__item">
 						...
 						<p>Our Triple Action shampoo and conditioner has helped thousands of men and women achieve life changing thicker and fuller looking hair.  In addition to powerful <strong>DHT blockers, Shapiro MD’s</strong> products contain essential nutrients for a healthy scalp and hair.</p>

 					</div>

 					<div class="behind-step__item">

 						<h3>POWERFUL &amp; ALL NATURAL</h3>

 						<p><strong>Dermatologist developed:</strong> specialized formulation gives the body the building blocks needed for a healthy scalp. A healthy scalp is critical to maximizing the retention of existing hair and the likelihood of promoting new hair growth.</p>
				...
				<h4 class="h4"><span class="text-success">THE LEADING #1 SOLUTION PATENTED FOR HAIR LOSS</span> <br> 
				...
				<div class="wrap-restore-hear">

					<div class="top">
						<h3>Try Shapiro MD® Regrowth System <span>Risk-Free for 60 Days!</span></h3>
						<h4>Pay $5.95 S&P Today to Try It Before You Buy It</h4>

						<ul>
							<li>If you keep the product after 30 days, you 
                            will be charged 2 monthly payments of $79.95</li>
							<li>A fresh shipment will be sent every 60 days with
                            same discounted monthly payments unless canceled</li>
							<li>For questions, returns, or to cancel, 
                            contact our 24 Hour Customer Service</li>
						</ul>
					</div>
					...
					<div class="bottom">
						<div class="product">
							<div class="head-product">
								<h3>RESTORE YOUR HAIR</h3>
								<h4 class="title"><span>Thicker, Stronger, & Healthier</span></h4>

								<div class="descr-product">
									<div class="left">
										<span class="green">Development</span>
										<span class="blue">by Dermatologists</span>
									</div>

									<div class="right">
										<h4>Triple Action <span>DHT Blocker</span></h4>
										<h5>Scientifically <span>Proven Natural Ingredients</span></h5>

										<p><span>Shapiro MD’s hair loss treatment is a patented formula that contains the 3 most potent DHT </span></p>
									</div>
								</div>
							</div>
							...
							<div class="product-main">
								<div class="flex">
									<div class="thumb">
										<img src="img/product-shapiro.png" alt="">
									</div>

									<div class="reviews">
										<div class="skil-wrap">
											<h5>Reverse the</h5>
											<h4 class="green">signs of embarrassing hair loss</h4>
											<div class="skil green"></div>
										</div>

										<div class="skil-wrap">
											<h5>Repair,</h5>
											<h4 class="bluee">Amplify, Protect, & Replenish Hair</h4>
											<div class="skil bluee"></div>
										</div>

										<div class="skil-wrap">
											<h5>Achieve</h5>
											<h4 class="violet">thicker and Fuller Hair</h4>
											<div class="skil bluee"></div>
										</div>

										<div class="descr">
											<strong>Join over 100,000 Men & Women</strong> who have trusted Shapiro MD®, the Hair Growth Experts! For a very limited time, we are allowing a limited number of customers to <strong>Try Shapiro MD Risk-Free! >></strong>
										</div>

										<div class="flag"><span>Internet Exclusive Offer<br>
										Available to US Residents Only</span></div>
									</div>
								</div>

								<div class="garante-wrap">
									<span></span>
									<span></span>

									<div class="border-garante"></div>
								</div>
							</div>
						</div>

						<div class="form-wrap-product">
							<div class="timer t-center"><img src="img/timer.jpg" alt=""></div>
									...
									<div class="inner-form">
										<form action="">
											<div class="title-form">
												<h3>TELL US WHERE TO SEND<br> <span>Your Offer Today</span></h3>
											</div>
											
											<div class="group-input">
												<input type="text" placeholder="First Name">
												<input type="text">
												<select name="sountry" class="black-color">
												...
												<input type="text" placeholder="Country Required" class="black-color">
												...
												<div class="wrap-checkbox">
													<label>
														...
														<span class="text">By submitting my information I agree to be shipped a 2 month supply of Shapiro MD for $5.95 shipping and processing, I certify that I am at least 18 years or oolder.</span>
													</label>
												</div>
							...
							<div class="img">
								...
								<img src="img/secure.jpg" alt="">
								<img src="img/norton.jpg" alt="">
							</div>
						</div>	
					</div>
				</div>	
