...
mr = (function (mr, $, window, document){
    ...
    $('.sidebar-menu-dropdown').on('click', function(){
        var el = $(this);
        el.find('.sidebar-menu-sub-list').slideToggle();
...
mr = (function (mr, $, window, document){
    ...
    var locations = [
      ...
      ['<div class="box-infobox"><div class="infobox-header"><span class="infobox-name">IMMUDYNE.</span><span class="infobox-title">PUERTO RICO</span></div><p>Phone #<br> (877) 907-4047</p><p>53 Calle Palmeras <br> Suite 802<br> San Juan, PR 00901</p></div>', 21.331815, -78.981255],
